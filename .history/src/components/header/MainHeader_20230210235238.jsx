...
const MainHeader = () => { 
    ...
    return (
        ...
        className="mr-auto mb-1 h-5 md:mr-0 "
         />
        <nav className="absolute top-0 left-0 flex h-full w-4/5 flex-col gap-y-[21px] bg-gray-400 p-8 font-bold md:static md:mr-auto md:flex md:flex-row md:gap-4 md:p-0">
